...
public static class AddCommand
{
    public static Command Build()
    {
        ...
        cmd.SetHandler((capName, projectPath) =>
        {
            ...
            {
                AnsiConsole.MarkupLine($"[yellow]{capName}[/] is already installed. Use [cyan]dev-start-dotnet upgrade[/] to refresh.");
                return;
            }
            ...
            AnsiConsole.MarkupLine($"[bold]dev-start-dotnet add[/] [cyan]{capName}[/] [grey]→[/] {root}");
