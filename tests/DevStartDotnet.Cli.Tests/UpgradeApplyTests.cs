...
namespace DevStartDotnet.Tests;

/// <summary>
/// Scenario coverage for the 3-way-merge logic used by `dev-start-dotnet upgrade --apply`.
...
public class UpgradeApplyTests : IDisposable
{
    ...
    {
        _sandbox = Directory.CreateTempSubdirectory("dev-start-dotnet-upgrade-").FullName;
    ...
    {
        var dir = Directory.CreateTempSubdirectory("dev-start-dotnet-bl-").FullName;
        try
        {
