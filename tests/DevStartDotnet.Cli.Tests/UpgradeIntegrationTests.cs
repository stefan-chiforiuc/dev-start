...
/// <summary>
/// End-to-end coverage for <c>dev-start-dotnet upgrade --apply</c>: each test sets
...
public class UpgradeIntegrationTests : IDisposable
{
    ...
    {
        _sandbox = Directory.CreateTempSubdirectory("dev-start-dotnet-upgrade-int-").FullName;
