...
/// <summary>
/// Exercises the `dev-start-dotnet add` pipeline against an already-scaffolded project.
...
public class AddCapabilityTests : IDisposable
{
    ...
    {
        _sandbox = Directory.CreateTempSubdirectory("dev-start-dotnet-add-").FullName;
